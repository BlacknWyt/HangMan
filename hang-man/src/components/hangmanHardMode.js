...
function HangManHardMode() {
  ...
  let [letters, lettersUpdate] = useState(['e', 's', 'p', 'i', 'o', 'n', 'a', 'g', 'e']);
  ...
  let check = (letter) => {
    ...
    if (win === true) {
      alert("Congrats you won, press restart to get a new word");
    }
    inputUpdate("");
  };
      ...
      <div style={{ marginTop: "30px", marginBottom: "30px" }}>
        ...
        <div>
          <input
            ...
            required
          />
          <button type="reset" onClick={() => check(input)}>
            Check
          </button>
        </div>
        <br />
...
export default HangManHardMode;
